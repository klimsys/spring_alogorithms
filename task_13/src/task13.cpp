...
std::vector<std::vector<double>> curriculum (int N, std::vector<std::vector<double>>& pairs) {
    std::sort(pairs.begin(), pairs.end(), [](const std::vector<double>& a, const std::vector<double>& b) {
        if (a[1] != b[1]) {
            return a[1] < b[1];
        }
        return a[0] < b[0];
    ...
    std::sort(selected_lessons.begin(), selected_lessons.end(), [](const std::vector<double>& a, const std::vector<double>& b) {
        return a[0] < b[0];
    });
